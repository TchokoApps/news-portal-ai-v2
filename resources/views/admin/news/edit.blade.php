...
@section('title', __('labels.edit_news'))
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('news.update', $news->id) }}" enctype="multipart/form-data" id="newsForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                @foreach($languages as $language)
                                    <option value="{{ $language->code }}" @selected(old('language', $news->language) == $language->code)>
                                        {{ $language->name }}
                                    </option>
                                @endforeach
                            </select>
                                ...
                                <div id="imagePreview" class="mt-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-2">
                                            <img src="{{ asset($news->image) }}" class="img-fluid" style="max-height: 200px;">
                                        </div>
                                    </div>
                                </div>
                            @else
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> {{ __('buttons.Update News') }}
                            </button>
