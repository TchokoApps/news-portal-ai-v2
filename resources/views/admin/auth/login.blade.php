...
<head>
    ...
    <title>{{ __('admin.Admin Login') }}</title>
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-5 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                        <div class="card-header"><h4>{{ __('admin.Admin Login') }}</h4></div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.login.store') }}">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="remember-me">{{ __('labels.Remember Me') }}</label>
                                    </div>
                                </div>

                                <div class="form-group d-flex justify-content-between align-items-center">
                                    <a href="{{ route('admin.forgot-password') }}" class="text-small">{{ __('admin.Forgot Password?') }}</a>
                                </div>
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ url('/') }}" class="text-small">{{ __('admin.Back to Home') }}</a>
                            </div>
                        </div>
                    </div>
