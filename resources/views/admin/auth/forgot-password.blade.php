...
<head>
    ...
    <title>{{ __('auth.Forgot Password?') }}</title>
            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-5 offset-lg-3 col-xl-4 offset-xl-4">
                    ...
                    <div class="card card-primary">
                        <div class="card-header"><h4>{{ __('auth.Forgot Password?') }}</h4></div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-4">
                                {{ __('auth.Enter your email address and we\'ll send you a link to reset your password.') }}
                            </p>
                            ...
                            <div class="text-center mt-3">
                                <a href="{{ route('admin.login') }}" class="text-small">{{ __('auth.Back to Login') }}</a>
                            </div>
                        </div>
                    </div>
