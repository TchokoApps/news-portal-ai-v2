                    ...
                    <form action="{{ route('language.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="code" name="code" class="form-control select2 @error('code') is-invalid @enderror">
                                ...
                                @forelse($availableLanguages as $code => $language)
                        ...
                        <div class="form-group">
                            ...
                            <select id="default" name="default" class="form-control @error('default') is-invalid @enderror">
                                ...
                                <option value="1" @if(old('default') === '1') selected @endif>Yes</option>
                                <option value="0" @if(old('default') === '0') selected @endif>No</option>
                            </select>
                            @error('default')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
